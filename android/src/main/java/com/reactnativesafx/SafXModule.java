...
public class SafXModule extends ReactContextBaseJavaModule {
  ...
  @ReactMethod
  public void unzip(String uriString, String destUriString,Boolean replaceIfDestExists, final Promise promise) {
    efficientDocumentHelper.unzip(uriString, destUriString,replaceIfDestExists, promise);
  }
